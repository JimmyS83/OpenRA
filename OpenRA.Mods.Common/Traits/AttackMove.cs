...
namespace OpenRA.Mods.Common.Traits
{
	...
	sealed class AttackMove : IIssueOrder, IResolveOrder, IOrderVoice
	{
		...
		{
			get { yield return new AttackMoveOrderTargeter(Info); }
		}
	...
	sealed class AttackMoveOrderTargeter : IOrderTargeter
	{
		...
		{
			// Alt (or whatever triggers ForceMove) is our "give me a plain Move" override.
			if (target.Type != TargetType.Terrain || modifiers.HasModifier(TargetModifiers.ForceMove))
				return false;
